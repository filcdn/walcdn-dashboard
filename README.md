...
Before starting development server you will need to obtain basic Cloudflare credentials and export them to your environment.

```
export CLOUDFLARE_API_KEY=<API KEY>
export CLOUDFLARE_DATABASE_ID=<DATABASE UUID>
